DROP DATABASE ProyectIndiv;
CREATE DATABASE IF NOT EXISTS ProyectIndiv;
USE ProyectIndiv;
...
select * from localidades_final;
select * from sucursales;
select * from clientes;
/*select * from localidad where localidad_censal_nombre like '%Buenos Aires%';
select  provincia from sucursales;
DROP TABLE IF EXISTS `provincia`;
DROP TABLE IF EXISTS `departamento`;
DROP TABLE IF EXISTS `municipio`;
DROP TABLE IF EXISTS `localidad`;
DROP TABLE IF EXISTS `localidades_final`;
